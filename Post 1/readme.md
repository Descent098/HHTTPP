...
**These two next sections are a repeat of the README.md sections in the overview folder, you can skip them by clicking [here](#how-http-works)**
...
![](../images/Post%201/http-request-response.png)
...
![](../images/Post%201/hhttpp-model.png)
